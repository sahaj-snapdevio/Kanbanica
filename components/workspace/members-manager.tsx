...
export function MembersManager({
  ...
  /** Admins can only manage Member/Guest; nobody edits Owner or themselves inline. */
                ...
                <Dialog open={transferOpen} onOpenChange={setTransferOpen}>
                  ...
                  <DialogContent>
                    <DialogHeader>
                      ...
                      <DialogDescription>
                        The new Owner gets full control. You become an Admin. This cannot be
                        undone by you.
                      </DialogDescription>
                    </DialogHeader>
      ...
      <Dialog open={!!removeTarget} onOpenChange={(open) => !open && setRemoveTarget(null)}>
        <DialogContent>
          <DialogHeader>
            ...
            <DialogDescription>
              They lose access to this workspace and all its Spaces. Tasks they created or were
              assigned to are kept.
            </DialogDescription>
          </DialogHeader>
          <DialogFooter>
                    ...
                    <TableRow key={invite.id}>
                      ...
                      <TableCell className="text-right space-x-1">
                        <Button
                          ...
                          onClick={() =>
                            run(
                              () => resendInvite({ workspaceId, memberId: invite.id }),
                        ...
                        <Button
                          ...
                          disabled={pending}
                          onClick={() =>
                            run(() => cancelInvite({ workspaceId, memberId: invite.id }))
                          }
                        >
                          Cancel
                        </Button>
