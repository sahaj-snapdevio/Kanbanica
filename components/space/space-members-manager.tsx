...
import { addSpaceMember, changeSpaceMemberPermission, removeSpaceMember } from "@/server/space";
              ...
              <AlertDialog>
                ...
                <AlertDialogContent>
                  <AlertDialogHeader>
                    ...
                    <AlertDialogDescription>
                      {member.user.name ?? member.user.email} will lose explicit access to this Space.
                      They remain a workspace member.
                    </AlertDialogDescription>
                  </AlertDialogHeader>
                  <AlertDialogFooter>
